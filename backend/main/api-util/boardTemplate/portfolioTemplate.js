...
class PortfolioTemplate extends AbstractTemplate
{
    constructor(logger, loggerInfo, board)
    {
        ...
        let createLayoutFunction = (outerNextTask) =>
        {
            ...
            let selected = {laneType: 'ready', title: 'Próximo ano', cardsWide: 1, orientation: 0, wipLimit: 10, activity: '', policy: 'Items que serão executados no próximo ano', children: []};

            let execution = {laneType: null, title: 'Entregáveis do Ano', orientation: 0, wipLimit: 3, activity: 'PLAN', policy: 'Items a serem entregues este ano', children: []};
            execution.children.push({laneType: 'inprogress', title: 'Projeto', cardsWide: 1, orientation: 0, wipLimit: 2, children: []});
            execution.children.push({laneType: 'wait', activity: '', title: 'Não Agendado', cardsWide: 1, orientation: 0, wipLimit: 2, children: []});
            execution.children.push({laneType: 'wait', activity: '', title: 'Q1', cardsWide: 1, orientation: 0, wipLimit: 2, children: []});
            execution.children.push({laneType: 'wait', activity: '', title: 'Q2', cardsWide: 1, orientation: 0, wipLimit: 2, children: []});
            execution.children.push({laneType: 'wait', activity: '', title: 'Q3', cardsWide: 1, orientation: 0, wipLimit: 2, children: []});
            execution.children.push({laneType: 'wait', activity: '', title: 'Q4', cardsWide: 1, orientation: 0, wipLimit: 2, children: []});
