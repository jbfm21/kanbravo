...
class SoftwareTemplate extends AbstractTemplate
{
    constructor(logger, loggerInfo, board)
    {
        ...
        let taskTypes = [
            {title: 'Requisitos', wipLimit: 0, policy: 'Levantamento de requisitos', avatar: {letter: 'RQ', foreColor: {a: 1, b: 0, g: 0, r: 0}, backgroundColor: {a: 0, b: 255, g: 255, r: 255}}, board: board._id},
            {title: 'Modelagem', wipLimit: 0, policy: 'Modelagem de Dados', avatar: {letter: 'MD', foreColor: {a: 1, b: 0, g: 0, r: 0}, backgroundColor: {a: 0, b: 255, g: 255, r: 255}}, board: board._id},
            {title: 'Teste', wipLimit: 0, policy: 'Teste', avatar: {letter: 'TE', foreColor: {a: 1, b: 0, g: 0, r: 0}, backgroundColor: {a: 0, b: 255, g: 255, r: 255}}, board: board._id},
            {title: 'Correção Defeitos', wipLimit: 0, policy: 'Correção de Defeitos', avatar: {letter: 'CD', foreColor: {a: 1, b: 0, g: 0, r: 0}, backgroundColor: {a: 0, b: 255, g: 255, r: 255}}, board: board._id}
        ];
        ...
        let createLayoutFunction = (outerNextTask) =>
        {
            ...
            let selected = {laneType: 'ready', title: 'Selecionado', cardsWide: 1, orientation: 0, wipLimit: 10, activity: 'SEL', policy: 'Items que ainda não foram priorizados', children: []};

            let priorized = {laneType: 'ready', title: 'Priorizado', cardsWide: 1, orientation: 0, wipLimit: 2, activity: 'PRI', policy: 'Items priorizados prontos para iniciar a execução', dateMetricConfig: {isStartLeadTime: true}, children: []};

            let execution = {laneType: null, title: 'Execução', orientation: 0, wipLimit: 3, activity: 'DSV', policy: 'Items em construção', children: [], dateMetricConfig: {isStartLeadTime: true, isStartCycleTime: true}};
            execution.children.push({laneType: 'inprogress', title: 'Fazendo', cardsWide: 1, orientation: 0, wipLimit: 2, children: []});
            execution.children.push({laneType: 'wait', title: 'Feito', cardsWide: 1, orientation: 0, wipLimit: 2, children: []});

            let test = {laneType: null, title: 'Teste', orientation: 0, wipLimit: 3, activity: 'TST', policy: 'Items sendo testado', children: []};
                test.children.push({laneType: null, title: 'Fazendo', orientation: 0, wipLimit: 2, children: [], dateMetricConfig: {isStartLeadTime: true, isStartCycleTime: true}});
                    let testDoingNode = test.children[0];
                    testDoingNode.children.push({laneType: 'inprogress', title: 'Equipe interna', cardsWide: 1, orientation: 1, wipLimit: 2, children: []});
                    testDoingNode.children.push({laneType: 'inprogress', title: 'Equipe externa', cardsWide: 1, orientation: 1, wipLimit: 1, children: []});
                test.children.push({laneType: 'wait', title: 'Feito', cardsWide: 1, orientation: 0, wipLimit: 2, children: [], dateMetricConfig: {isStartLeadTime: true, isStartCycleTime: true, isEndCycleTime: true}});

            let deployment = {laneType: 'inprogress', title: 'Implantação', cardsWide: 1, orientation: 0, wipLimit: 4, activity: 'IMPL', policy: 'Items em implantação', children: [], dateMetricConfig: {isStartLeadTime: true, isStartCycleTime: true, isEndCycleTime: true}};
            let done = {laneType: 'completed', title: 'Finalizadas', cardsWide: 2, orientation: 0, wipLimit: 0, children: [], dateMetricConfig: {isStartLeadTime: true, isStartCycleTime: true, isEndCycleTime: true, isEndLeadTime: true}};

            root.rootNode.children.push(selected);
            root.rootNode.children.push(priorized);
            root.rootNode.children.push(execution);
            root.rootNode.children.push(test);
            root.rootNode.children.push(deployment);
...
module.exports = SoftwareTemplate;
