...
exports.createFixtures = function(schemaEntity, createEntity, nextTaskFromCaller)
{
     let endTask = (err) =>
     {
         return nextTaskFromCaller(err, userFixtures, fixtures);
     };
     let createPriorityFixtures = () =>
     {
        fixtures.create(
        [
            {name: 'boardEntity1_Child1', model: schemaEntity, val: createEntity(fixtures.boardEntity1)},
            {name: 'boardEntity2_1_Child1', model: schemaEntity, val: createEntity(fixtures.boardEntity2_1)},
            {name: 'boardEntity2_1_Child2', model: schemaEntity, val: createEntity(fixtures.boardEntity2_1)},
            {name: 'boardEntity2_2_Child1', model: schemaEntity, val: createEntity(fixtures.boardEntity2_2)}
        ], endTask);
     };
